const categoriesContainer = document.querySelector(".form__categories");
const tasksContainer = document.querySelector(".form__tasks");
const inputText = document.querySelector(".form__inputText");
...
const renderCategories = () => {
    categories.forEach((item) => {
        ...
        category.innerHTML = `
        <input type="radio" name="category" id="${item}" ${item === "general" ? "checked" : ""}/>
